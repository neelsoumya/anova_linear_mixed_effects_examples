...
# Make a linear mixed effects model
...
We added “gender” as a fixed effect because the relationship
...
You would report this result the following way:
 ...
 politeness affected pitch ($\chi$  (1)=11.94, p=0.00055), lowering it by
...
interaction? We didn’t talk much about interactions yet, but say, you predicted
